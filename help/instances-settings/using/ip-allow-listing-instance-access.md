...
>[!IMPORTANT]
>
>この機能は、AWS でホストされる Campaign v7／v8 インスタンスと、Microsoft Azure でホストされる Campaign v8 インスタンスで使用できます。
...
* [セキュリティゾーンをオペレーターにリンクする](https://experienceleague.adobe.com/docs/campaign-classic/using/installing-campaign-classic/additional-configurations/security-zones.html?lang=ja#linking-a-security-zone-to-an-operator)

...
>[!IMPORTANT]
>
>この機能は、AWSでホストされているCampaign v7/v8 インスタンスと、Microsoft AzureでホストされているCampaign v8 インスタンスで使用できます。
...
* [オペレーターへのセキュリティゾーンのリンク](https://experienceleague.adobe.com/docs/campaign-classic/using/installing-campaign-classic/additional-configurations/security-zones.html?lang=ja#linking-a-security-zone-to-an-operator)

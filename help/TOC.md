...
+ コントロールパネルの概要 {#discover-control-panel}
   ...
   + [Campaign コントロールパネルへの権限の管理](discover/using/managing-permissions.md)
   + [DiscoverCampaign コントロールパネルインターフェイス](discover/using/discovering-the-interface.md)
...
+ SFTP の管理 {#sftp-management}
   ...
   + [SFTP サーバーにログインする](sftp/using/logging-into-sftp-server.md)
   + [よくある質問](sftp/using/common-questions.md)
+ サブドメインと証明書 {#subdomains-and-certificates}
   + [サブドメインのブランディング](subdomains-certificates/using/subdomains-branding.md)
   + [サブドメインの監視](subdomains-certificates/using/monitoring-subdomains.md)
   + [新しいサブドメインの設定](subdomains-certificates/using/setting-up-new-subdomain.md)
   + [TXT レコードを管理](subdomains-certificates/using/managing-txt-records.md)
   ...
   + SSL 証明書の更新 {#renew-ssl}
      ...
      + [CSR を生成](subdomains-certificates/using/generate-csr.md)
...
+ パフォーマンス監視 {#performance-monitoring}
   ...
   + データベース監視 {#database-monitoring}
      ...
      + [データベース容量超過を防ぐ](performance-monitoring/using/database-preventing-overload.md)

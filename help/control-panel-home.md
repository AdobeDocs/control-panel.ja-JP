...
**SFTP サーバーの容量を消費する上位 10 個のファイル**

SFTP サーバー上で最も容量を消費している上位 10 個のファイルを識別できるようになりました。 [詳細情報](sftp/using/sftp-storage-management.md)
...
CSR 生成プロセスがいくつか強化されました。 [詳細情報](subdomains-certificates/using/renewing-subdomain-certificate.md)
